...
-- 2017-01-01,NPitti,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_NPitti')
	 Begin 
	  Alter Database [Assignment06DB_NPitti] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_NPitti;
	 End
	Create Database Assignment06DB_NPitti;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_NPitti;
...
DENY SELECT ON Categories 
TO PUBLIC;
GO
DENY SELECT ON Products 
TO PUBLIC;
GO
DENY SELECT ON Employees 
TO PUBLIC;
GO
DENY SELECT ON Inventories 
TO PUBLIC;
GO

GRANT SELECT ON Categories
TO PUBLIC;
GO
...
I.InventoryDate, E.EmployeeFirstName + ' ' + E.EmployeeLastName 
AS EmployeeName
